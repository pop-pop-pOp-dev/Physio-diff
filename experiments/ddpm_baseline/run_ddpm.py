...
from experiments.common.visuals import save_class_compare, save_bvp_spectrum
...
def main(cfg):
    ...
    # Fair post-processing (apply consistently across methods)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="experiments/ddpm_baseline/configs/base.yaml")
