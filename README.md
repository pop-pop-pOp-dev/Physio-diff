...
-------------------------
- This public repository intentionally excludes datasets and generated artifacts
  (e.g., `data/`, `outputs*/`, checkpoints, logs, and per-run result JSON files).
- It keeps code assets only: training scripts, evaluation scripts, protocol runners,
  configs, and report-building scripts.
